...
INSERT INTO `__new_solutions`("id", "created", "experiment", "publication", "pull_request", "agent") SELECT "id", "created", "experiment", "publication", "pull_request", "agent" FROM `solutions`;--> statement-breakpoint
